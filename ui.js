            ...
            <div class="card card-body mb-3">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <a href="${user.html_url}" target="_blank" class="btn btn-primary brn-block mb-3">View profile</a>
                    </div>
                    <div class="col-md-9">
                ...
                <div class="card card-body mb-2">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <span class="badge badge-success mb-3">Forks: ${repo.forms_output}</span>
                        </div>
                    </div>
                </div>
            `;
